function change(especialidad, medico, horario) {
  ...
  if (especialidad.value == "Cardiología") {
    var optionArray = [
      "|",
      "Malena Mendoza|Malena Mendoza",
      "Delfina Rios|Delfina Rios",
      "Bautista Olivera|Bautista Olivera",
    ];
  } else if (especialidad.value == "Dermatología") {
    var optionArray = [
      "|",
      "Pablo Vargas|Pablo Vargas",
      "Julieta Castillo|Julieta Castillo",
      "Santino Lopez|Santino Lopez",
    ];
  } else if (especialidad.value == "Medicina General") {
    var optionArray = [
      "|",
      "Mateo Villalba|Mateo Villalba",
      "Valentina Paez|Valentina Paez",
      "Tomas Cruz|Tomas Cruz",
    ];
  } else if (especialidad.value == "Neurología") {
    var optionArray = [
      "|",
      "Azul Gomez|Azul Gomez",
      "Felipe Paez|Felipe Paez",
      "Valentino Soria|Valentino Soria",
    ];
  } else if (especialidad.value == "Obstetricia y Ginecología") {
    var optionArray = [
      "|",
      "Renata Ferreyra|Renata Ferreyra",
      "Francisco Miranda|Francisco Miranda",
      "Luna Torres|Luna Torres",
    ];
  } else if (especialidad.value == "Oftalmología") {
    var optionArray = [
      "|",
      "Ambar Miranda|Ambar Miranda",
      "Benicio Rodriguez|Benicio Rodriguez",
      "Sofia Rojas|Sofia Rojas",
    ];
  } else if (especialidad.value == "Pediatría") {
    var optionArray = [
      "|",
      "Emilia Ruiz|Emilia Ruiz",
      "Lorenzo Silva|Lorenzo Silva",
      "Agustin Farias|Agustin Farias",
    ];
